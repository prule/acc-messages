...
class AccBroadcastingClientTest {
    ...
    void testBuildRegisterCommandApplication() {
        ...
        AccBroadcastingOutbound packet = new AccBroadcastingOutbound(new ByteBufferKaitaiStream(result));
        assertEquals(AccBroadcastingOutbound.OutboundMsgType.REGISTER_COMMAND_APPLICATION, packet.msgType());
    ...
    void testBuildUnregisterCommandApplication() {
        ...
        AccBroadcastingOutbound packet = new AccBroadcastingOutbound(new ByteBufferKaitaiStream(result));
        assertEquals(AccBroadcastingOutbound.OutboundMsgType.UNREGISTER_COMMAND_APPLICATION, packet.msgType());
    ...
    void testBuildChangeFocus() {
        ...
        byte[] result = client.buildChangeFocus(connectionId, changeCarFocus, carIndex, changeCamera, cameraSet, camera);
