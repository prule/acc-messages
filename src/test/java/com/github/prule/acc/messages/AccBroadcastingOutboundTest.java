...
class AccBroadcastingOutboundTest {
  ...
  private static Stream<Arguments> provideOutboundMessages() {
    return Stream.of(
        ...
        // Protocol: 04, Name: "Test" (0400 54657374), Pass: "pw" (0200 7077), Interval: 1000ms
        // (E8030000), CmdPass: "" (0000)
        Arguments.of(
            "01 04 0400 54657374 0200 7077 E8030000 0000",
            AccBroadcastingOutbound.OutboundMsgType.REGISTER_COMMAND_APPLICATION,
            (Consumer<AccBroadcastingOutbound>)
                p -> {
        ...
        // CHANGE_FOCUS (32 -> 50)
        // ConnectionId: 1 (01000000), Focus: 1, CarIdx: 12 (0C00), Cam: 1, Set: "Main" (0400
        // 4D61696E), Cam: "Dash" (0400 44617368)
        Arguments.of(
