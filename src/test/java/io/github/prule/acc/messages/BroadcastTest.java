...
class BroadcastTest {
  ...
  void testResult(String hexString, Consumer<AccBroadcastingInbound.BroadcastingEvent> verifier) {
  ...
  private static Stream<Arguments> provideResults() {
    return Stream.of(
        Arguments.of(
            ...
            expect(AccBroadcastingInbound.BroadcastType.LAPCOMPLETED, "01:33.695", 904977, 0)));
  }
  ...
  void example() {
    ...
    AccBroadcastingInbound.BroadcastingEvent result =
        (AccBroadcastingInbound.BroadcastingEvent) packet.body();
