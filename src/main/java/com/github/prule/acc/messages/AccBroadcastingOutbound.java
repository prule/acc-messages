...
/** Outbound messages (app → ACC). Reference: Kunos Simulazioni ksBroadcastingNetwork SDK */
public class AccBroadcastingOutbound extends KaitaiStruct {
  ...
  public enum OutboundMsgType {
    ...
    static {
      for (OutboundMsgType e : OutboundMsgType.values()) byId.put(e.id(), e);
    }

    public static OutboundMsgType byId(long id) {
      return byId.get(id);
    }
  }
  ...
  public AccBroadcastingOutbound(
      KaitaiStream _io, KaitaiStruct _parent, AccBroadcastingOutbound _root) {
    super(_io);
  ...
  public static class AccString extends KaitaiStruct {
    ...
    public AccBroadcastingOutbound _root() {
      return _root;
    }
  ...
  public static class ChangeFocus extends KaitaiStruct {
    ...
    public ChangeFocus(
        KaitaiStream _io, AccBroadcastingOutbound _parent, AccBroadcastingOutbound _root) {
      super(_io);
      this._parent = _parent;
      this._root = _root;
      _read();
    ...
    public int changeCarFocus() {
      return changeCarFocus;
    }
    ...
    public AccString cameraSet() {
      return cameraSet;
    }

    public AccString camera() {
      return camera;
    }
    ...
    public AccBroadcastingOutbound _parent() {
      return _parent;
    }
  }
  ...
  public static class RegisterCommandApplication extends KaitaiStruct {
    ...
    public RegisterCommandApplication(
        KaitaiStream _io, AccBroadcastingOutbound _parent, AccBroadcastingOutbound _root) {
      super(_io);
      this._parent = _parent;
      this._root = _root;
    ...
    public AccString displayName() {
      return displayName;
    }

    public AccString connectionPassword() {
      return connectionPassword;
    }

    public int msRealtimeUpdateInterval() {
      return msRealtimeUpdateInterval;
    }

    public AccString commandPassword() {
  ...
  public static class UnregisterCommandApplication extends KaitaiStruct {
    ...
    public UnregisterCommandApplication(
        KaitaiStream _io, AccBroadcastingOutbound _parent, AccBroadcastingOutbound _root) {
      super(_io);
      this._parent = _parent;
      this._root = _root;
  ...
  public OutboundMsgType msgType() {
    return msgType;
  }
